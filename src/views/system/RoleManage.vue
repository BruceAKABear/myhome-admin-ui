  ...
  <div class="page-container">
    <div class='table-header-box'>
      ...
      <div class='header-option-box'>
        <el-button icon='el-icon-plus' size='mini' type='warning' @click='showAddDia'>添加角色</el-button>
      </div>
    </div>
    ...
    <el-dialog :visible.sync='dialogVisible' :title="newObj.id?'修改角色':'新增角色'" width="700px">
      <el-row :gutter="20">
        <el-col :span="14">
    ...
    return {
      ...
      defaultProps: {
        ...
        label: function(data, node) {
          return _this.$t('permMenu.' + data.symbol)
        }
      }
    }
  },
